...
public class GenerateMesh : MonoBehaviour {
    ...
    //    }
    //    Debug.Log("num xsegs = " + xSegments + ", num zsegs = " + zSegments);
    ...
    //            float height00 = GetHeight(x + 0, z + 0, xSegments, zSegments, noiseOffset, noiseScale, computeShader);
    //            float height01 = GetHeight(x + 0, z + 1, xSegments, zSegments, noiseOffset, noiseScale, computeShader);
    //            float height10 = GetHeight(x + 1, z + 0, xSegments, zSegments, noiseOffset, noiseScale, computeShader);
    //            float height11 = GetHeight(x + 1, z + 1, xSegments, zSegments, noiseOffset, noiseScale, computeShader);
    //            //Debug.Log("height00 = " + height00 + ", height01 = " + height01 + ", height10 = " + height10 + ", height11 = " + height11);
    ...
    private float[] TestMe2(ComputeShader compShader, Data[] positionData)
    {
        ...
        //{
        //    resultData[i] = Mathf.PerlinNoise(positionData[i].x, positionData[i].y);
        //}
        Debug.Log("Sending positionData[0].x = " + positionData[0].x + ", positionData[0].y = " + positionData[0].y);
        int kernelIndex = 0;
